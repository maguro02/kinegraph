 ...
 */
export function setup_worker(scope) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.setup_worker(retptr, addBorrowedObject(scope));
...
export class DrawEngine {
    ...
    constructor(canvas_width, canvas_height) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.drawengine_new(retptr, canvas_width, canvas_height);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    ...
    resize(new_width, new_height) {
        wasm.drawengine_resize(this.__wbg_ptr, new_width, new_height);
    }
    /**
    ...
    begin_stroke(x, y, pressure, r, g, b, a, brush_type, size) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.drawengine_begin_stroke(retptr, this.__wbg_ptr, x, y, pressure, r, g, b, a, brush_type, size);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    add_point(x, y, pressure) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.drawengine_add_point(retptr, this.__wbg_ptr, x, y, pressure);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    end_stroke() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.drawengine_end_stroke(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    remove_stroke(stroke_id) {
        const ret = wasm.drawengine_remove_stroke(this.__wbg_ptr, stroke_id);
        return ret !== 0;
    }
    /**
     * 全ストロークをクリア (WASM API)
    ...
    clear() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.drawengine_clear(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    undo() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.drawengine_undo(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    redo() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.drawengine_redo(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     */
    get_shared_buffer() {
        const ret = wasm.drawengine_get_shared_buffer(this.__wbg_ptr);
...
const DrawingContextFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_drawingcontext_free(ptr >>> 0, 1));

export class DrawingContext {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(DrawingContext.prototype);
        obj.__wbg_ptr = ptr;
        DrawingContextFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        DrawingContextFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_drawingcontext_free(ptr, 0);
    }
    /**
     * @param {number} width
     * @param {number} height
     * @returns {Promise<DrawingContext>}
     */
    static new(width, height) {
        const ret = wasm.drawingcontext_new(width, height);
        return takeObject(ret);
    }
    /**
     ...
     * @param {number} width
     */
    draw_stroke(points, color, width) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArrayF32ToWasm0(points, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passArrayF32ToWasm0(color, wasm.__wbindgen_export_2);
            const len1 = WASM_VECTOR_LEN;
            wasm.drawingcontext_draw_stroke(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1, width);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    clear(color) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArrayF32ToWasm0(color, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            wasm.drawingcontext_clear(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    get_pixels() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.drawingcontext_get_pixels(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
     ...
     */
    set_shared_buffer(buffer) {
        _assertClass(buffer, SharedBuffer);
        var ptr0 = buffer.__destroy_into_raw();
        wasm.drawingcontext_set_shared_buffer(this.__wbg_ptr, ptr0);
    }
    copy_to_shared_buffer() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.drawingcontext_copy_to_shared_buffer(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
     ...
     * @param {number} width
     */
    draw_stroke_from_typed_array(points, color, width) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.drawingcontext_draw_stroke_from_typed_array(retptr, this.__wbg_ptr, addHeapObject(points), addHeapObject(color), width);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    resize(width, height) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.drawingcontext_resize(retptr, this.__wbg_ptr, width, height);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
...
const WebGPURendererFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_webgpurenderer_free(ptr >>> 0, 1));
...
export class WebGPURenderer {
    ...
    /**
     * @param {OffscreenCanvas | null} [canvas]
     * @returns {Promise<WebGPURenderer>}
     */
    static new(canvas) {
        const ret = wasm.webgpurenderer_new(isLikeNone(canvas) ? 0 : addHeapObject(canvas));
        return takeObject(ret);
    }
    render() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.webgpurenderer_render(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
...
export class WorkerContext {
     ...
     */
    init(canvas) {
        const ret = wasm.workercontext_init(this.__wbg_ptr, addHeapObject(canvas));
        return takeObject(ret);
    }
    /**
     * @param {any} command
     */
    process_draw_command(command) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.workercontext_process_draw_command(retptr, this.__wbg_ptr, addHeapObject(command));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_drawingcontext_new = function(arg0) {
        const ret = DrawingContext.__wrap(arg0);
        return addHeapObject(ret);
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('kinegraph_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
